...
namespace Variamos.DevOpsDsl
{
	...
	/// </summary>
	internal partial class DevOpsDslCommandSet : DevOpsDslCommandSetBase
	{
		/// <summary>
		/// Constructs a new DevOpsDslCommandSet.
		/// </summary>
		public DevOpsDslCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DevOpsDslCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DevOpsDslCommandSetBase.
		/// </summary>
		protected DevOpsDslCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDevOpsDslExplorerCommand,
				typeof(DevOpsDslEditorFactory).GUID);
		...
		{
			DevOpsDslExplorerToolWindow explorer = this.DevOpsDslExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DevOpsDslDocData CurrentDevOpsDslDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DevOpsDslDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DevOpsDslDocView CurrentDevOpsDslDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DevOpsDslDocView;
			}
		}
		...
		/// </summary>
		protected DevOpsDslExplorerToolWindow DevOpsDslExplorerToolWindow
		{
			get
			{
				DevOpsDslExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DevOpsDslExplorerToolWindow), true) as DevOpsDslExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DevOpsDslExplorerToolWindow explorerWindow = this.DevOpsDslExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DevOpsDslClipboardCommandSet : DevOpsDslClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DevOpsDslClipboardCommandSet.
		/// </summary>
		public DevOpsDslClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DevOpsDslClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DevOpsDslClipboardCommandSetBase.
		/// </summary>
		protected DevOpsDslClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
