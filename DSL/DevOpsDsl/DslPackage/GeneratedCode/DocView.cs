...
namespace Variamos.DevOpsDsl
{
	...
	/// </summary>
	internal partial class DevOpsDslDocView : DevOpsDslDocViewBase
	{
		/// <summary>
		/// Constructs a new DevOpsDslDocView.
		/// </summary>
		public DevOpsDslDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DevOpsDslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DevOpsDslDocView.
		/// </summary>
		protected DevOpsDslDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DevOpsDslDocDataBase docData = this.DocData as DevOpsDslDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DevOpsDslDocViewBase should be an DevOpsDslDocDataBase!");
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Variamos.DevOpsDsl.DevOpsDslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Variamos.DevOpsDsl.DevOpsDslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DevOpsDslDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Variamos.DevOpsDsl.DevOpsDslHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Variamos.DevOpsDsl.DevOpsDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Variamos.DevOpsDsl.DevOpsDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
