...
namespace Variamos.DevOpsDsl
{
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"DevOpsDsl", typeof(DevOpsDslEditorFactory))]

	internal abstract partial class DevOpsDslPackageBase : DslShell::AsyncModelingPackage
	{
		protected global::Variamos.DevOpsDsl.DevOpsDslToolboxHelper toolboxHelper;	
		...
		protected async override System.Threading.Tasks.Task InitializeAsync(CancellationToken cancellationToken, IProgress<VSShell.ServiceProgressData> progress)
		{
			...
			this.RegisterEditorFactory(new DevOpsDslEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Variamos.DevOpsDsl.DevOpsDslToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			DevOpsDslCommandSet commandSet = new DevOpsDslCommandSet(this);
			...
			DevOpsDslClipboardCommandSet clipboardCommandSet = new DevOpsDslClipboardCommandSet(this);
			await clipboardCommandSet.InitializeAsync(cancellationToken);
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(DevOpsDslExplorerToolWindow));
		...
		{
			if (toolWindowType == typeof(DevOpsDslExplorerToolWindow).GUID)
			{
				return this;
			}
...
namespace Variamos.DevOpsDsl
{
	...
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::Variamos.DevOpsDsl.DevOpsDslDirectiveProcessor), global::Variamos.DevOpsDsl.DevOpsDslDirectiveProcessor.DevOpsDslDirectiveProcessorName, "A directive processor that provides access to DevOpsDsl files")]
	[global::System.Runtime.InteropServices.Guid(Constants.DevOpsDslPackageId)]
	internal sealed partial class DevOpsDslPackage : DevOpsDslPackageBase
	{
	}
}