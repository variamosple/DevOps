...
namespace Variamos.DevOpsDsl
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DevOpsDslEditorFactoryId)]
	internal partial class DevOpsDslEditorFactory : DevOpsDslEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DevOpsDslEditorFactory.
		/// </summary>
		public DevOpsDslEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DevOpsDslEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DevOpsDslEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DevOpsDslDocData(this.ServiceProvider, typeof(DevOpsDslEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DevOpsDslDocView(docData, this.ServiceProvider);
		}
	}
}
