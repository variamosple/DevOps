...
namespace Variamos.DevOpsDsl
{
	...
	/// </summary>
	internal partial class DevOpsDslExplorer : DevOpsDslExplorerBase
	{
		/// <summary>
		/// Constructs a new DevOpsDslExplorer.
		/// </summary>
		public DevOpsDslExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the DevOpsDslExplorerToolWindow.
	/// </summary>
	internal abstract class DevOpsDslExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new DevOpsDslExplorerBase.
		/// </summary>
		protected DevOpsDslExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DevOpsDslExplorerMenu;
			}
		}
