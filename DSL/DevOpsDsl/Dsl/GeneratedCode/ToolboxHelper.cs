...
namespace Variamos.DevOpsDsl
{
	...
	/// </remarks>
	public partial class DevOpsDslToolboxHelper : DevOpsDslToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DevOpsDslToolboxHelper.
		/// </summary>
		public DevOpsDslToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class DevOpsDslToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify DevOpsDsl toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "DevOpsDsl.1.0";
		...
		/// <summary>
		/// Constructs a new DevOpsDslToolboxHelperBase.
		/// </summary>
		protected DevOpsDslToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Variamos.DevOpsDsl.DevOpsDslDomainModel.SingletonResourceManager.GetString("DevOpsDslToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Variamos.DevOpsDsl.DevOpsDslDomainModel.SingletonResourceManager;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Variamos.DevOpsDsl.DevOpsDslDomainModel));
