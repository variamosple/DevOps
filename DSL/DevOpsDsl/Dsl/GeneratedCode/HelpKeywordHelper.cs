...
namespace Variamos.DevOpsDsl
{
	...
	/// </remarks>
	public partial class DevOpsDslHelpKeywordHelper : DevOpsDslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DevOpsDslHelpKeywordHelper.
		/// </summary>
		protected DevOpsDslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DevOpsDslHelpKeywordHelper.
		/// </summary>
		public static DevOpsDslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DevOpsDslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DevOpsDslHelpKeywordHelperBase.
		/// </summary>
		protected DevOpsDslHelpKeywordHelperBase()
			: base() { }
