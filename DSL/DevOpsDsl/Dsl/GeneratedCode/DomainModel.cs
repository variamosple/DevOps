	...
	public partial class DevOpsDslDomainModel : DslModeling::DomainModel
	{
		...
		protected sealed override DomainMemberInfo[] GetGeneratedDomainProperties()
		{
			return new DomainMemberInfo[]
			{
				...
				new DomainMemberInfo(typeof(Practice), "CurrentValue", Practice.CurrentValueDomainPropertyId, typeof(Practice.CurrentValuePropertyHandler)),
				new DomainMemberInfo(typeof(Practice), "TargetValue", Practice.TargetValueDomainPropertyId, typeof(Practice.TargetValuePropertyHandler)),
