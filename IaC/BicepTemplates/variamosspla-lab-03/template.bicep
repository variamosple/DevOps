param sites_VariaMos_name string = 'variamos02'
param sites_variamos_ms_languages_name string = '${sites_VariaMos_name}variamos-ms-languages'
param sites_variamos_ms_apireference_name string = '${sites_VariaMos_name}variamos-ms-apireference'
param sites_variamos_ms_restrictions_name string = '${sites_VariaMos_name}variamos-ms-restrictions'
param serverfarms_ASP_variamosspla_a699_name string = '${sites_VariaMos_name}-asp5000'
